...
export const teamHeads: TeamMember[] = [
  ...
  { name: "Indrayue Roy", description: "Event Management", imageSrc: "/images/team/indrayue-roy.webp" },
  { name: "Shanti Toppo", description: "PR", imageSrc: "/images/team/shanti-toppo.webp" },
  { name: "Pinakshi Priyadarshini", description: "Event Management", imageSrc: "/images/team/pinakshi-priyadarshini.webp" },
  { name: "Ayush Sinha", description: "WebDev", imageSrc: "/images/team/ayush-sinha.webp" },
  { name: "Aman Kumar", description: "Event Management", imageSrc: "/images/team/aman-kumar.webp" },
  { name: "Shubham Ranjan", description: "Event Management", imageSrc: "/images/team/shubham-ranjan.webp" },
  { name: "Amit Kuanr", description: "Event Management", imageSrc: "/images/team/amit-kuanr.webp" },
  { name: "Dhruv Agarwal", description: "WebDev", imageSrc: "/images/team/dhruv-agarwal.webp" },
  { name: "Pritam Raj Mahapatro", description: "Sponsorship", imageSrc: "/images/team/pritam-raj-mahapa.webp" },
  ...
  { name: "Harsh Daruka", description: "Event Management", imageSrc: "/images/team/harsh-daruka.webp" },
  ...
  { name: "Anshul Kumar", description: "Event Management", imageSrc: "/images/team/anshul-kumar.webp" },
  ...
  { name: "Sunny Saurabh", description: "Event Management", imageSrc: "/images/team/sunny-saurabh.webp" },
  { name: "Priyal Todi", description: "Creative", imageSrc: "/images/team/priyal-todi.webp" },
  { name: "Priyanshu Maurya", description: "Creative", imageSrc: "/images/team/priyanshu-maurya.webp" },
];
