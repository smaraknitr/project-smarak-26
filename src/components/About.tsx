                ...
                <div className="relative z-20 w-full max-w-[1400px] mx-auto px-6 md:px-10 lg:px-16">
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-center gap-12 lg:gap-12">
                        ...
                        <div className="lg:w-[55%]">
                            <p className="text-[#3b2a1e] text-xl md:text-3xl lg:text-[2.2rem] font-crimson text-left">
                                Smarak is brought to life by the combined efforts of the faculty and
                                students of the Civil Engineering Department at NIT Rourkela.
                                With faculty members providing their expertise and guidance, and
                                students infusing fresh ideas and energy, our team ensures a seamless
                                blend of learning, competition, and innovation. Together, we craft
                                an experience that challenges, inspires, and pushes the boundaries
