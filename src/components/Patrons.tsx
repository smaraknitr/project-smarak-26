...
import { teamHeads } from "../app/config/patron";
                    ...
                    {teamHeads.map((card, index) => (
                        ...
                        >
                            ...
                            <div className="bg-gradient-to-b from-[#f5b461] to-[#e8a047] py-2 md:py-3 lg:py-4 flex flex-col items-center justify-center overflow-hidden flex-grow">
                                ...
                                <p className={`text-center text-[#7a1a0f] font-semibold mt-0.5 uppercase tracking-widest w-full px-1 sm:px-2 ${card.description.length > 15
